...
public class OneFileDataSetGenerator {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try (BufferedWriter sample = Files.newBufferedWriter(Paths.get("samples", "sample1", "sampleOneFile.csv"), StandardOpenOption.CREATE_NEW)) {
