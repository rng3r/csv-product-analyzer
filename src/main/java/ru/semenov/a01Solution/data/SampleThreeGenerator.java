...
public class SampleThreeGenerator {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try (BufferedWriter sample = Files.newBufferedWriter(Paths.get("samples","sample3", "sample3File.csv"), StandardOpenOption.CREATE_NEW)) {
        ...
        for (int i = 0; i < 15; i++) {
            ...
            try (BufferedWriter sample = Files.newBufferedWriter(Paths.get("samples","sample3", "sample3File_" + (i+1) + ".csv"), StandardOpenOption.CREATE_NEW)) {
